...
-(void)applyCustomDefaults
{
    ...
    self.dayTitleTextColor = attributes[CLCalendarDayTitleTextColor]? attributes[CLCalendarDayTitleTextColor]:RGB_HEX(CLCalendarDayTitleTextColorDefault);
...
-(UIImageView *)backgroundImageView
{
    ...
    _backgroundImageView.backgroundColor = self.backgroundImageColor? self.backgroundImageColor : [UIColor colorWithPatternImage:[TWUtility gradientImageWithBounds:CGRectMake(0, 0, APPCONFIG_UI_SCREEN_FWIDTH, self.height) colors:@[RGB_HEX(0x1b92da), RGB_HEX(0x34b5ec)]]];;
